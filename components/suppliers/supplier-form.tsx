...
export function SupplierForm({
  ...
  const selectCompany = (company: BrregEnhet) => {
    ...
    // Populate contact info from Brreg if available
    if (company.hjemmeside) {
      form.setValue("website", company.hjemmeside, { shouldValidate: true });
    }
    if (company.telefon) {
      form.setValue("phone", company.telefon, { shouldValidate: true });
    }
